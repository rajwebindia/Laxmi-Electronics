...
const Careers = () => {
  ...
  return (
    <div className="w-full">
      ...
      <section className="relative w-full py-12 md:py-20 lg:py-32 xl:py-40 px-4 sm:px-6 md:px-8 lg:px-[48px] bg-gradient-to-b from-gray-50 to-white">
        <div className="mx-auto max-w-7xl">
          ...
          {/* Section Header */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-12 mb-8 md:mb-12 lg:mb-16 xl:mb-20">
            {/* Left Side - Tag */}
            <div
            ...
            <div
              className="lg:col-span-2 about-us-slide-up"
              ref={(el) => (slideUpRefs.current[0] = el)}
            >
              <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-light text-[#08222B] mb-4 md:mb-6 leading-tight">
          ...
          <div className="about-us-slide-up mb-16" ref={(el) => (slideUpRefs.current[1] = el)}>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-6 mb-8 md:mb-12">
              <div className="flex items-center gap-3 md:gap-4">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-[#08222B] rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-5 h-5 md:w-6 md:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </div>
                <h4 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-light text-[#08222B]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {/* Requirement 1 */}
              <div className="bg-white rounded-lg shadow-md border border-gray-200 p-4 md:p-6 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group">
                <div className="mb-4">
              ...
              {/* Requirement 3 */}
              <div className="bg-white rounded-lg shadow-md border border-gray-200 p-4 md:p-6 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group md:col-span-2 lg:col-span-1">
                <div className="mb-4">
                  <div className="flex items-start justify-between mb-2">
                    <h4 className="text-xl font-semibold text-[#08222B] group-hover:text-[#9CAEAF] transition-colors duration-200">
                      03
          ...
          <div className="about-us-fade-in" ref={(el) => (fadeInRefs.current[5] = el)}>
            <div className="bg-gradient-to-r from-[#08222B] to-[#0a2d38] p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 rounded-lg shadow-lg">
              <div className="max-w-4xl">
                <div className="flex items-start gap-3 md:gap-4 mb-4 md:mb-6">
                  <div className="flex-shrink-0 mt-1">
                    <svg className="w-6 h-6 md:w-8 md:h-8 text-[#9CAEAF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
                    <h4 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-light text-white mb-3 md:mb-4">
                      Ready to Join Us?
                    </h4>
                    <p className="text-gray-200 text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed mb-4 md:mb-6">
                    ...
                    <a 
                      ...
                      className="inline-flex items-center gap-0.5 md:gap-3 text-[#9CAEAF] hover:text-white text-sm sm:text-base md:text-lg lg:text-xl font-medium transition-colors duration-200 group break-all"
                    >
                      ...
                      <svg className="w-4 h-4 md:w-5 md:h-5 transform group-hover:translate-x-1 transition-transform duration-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
