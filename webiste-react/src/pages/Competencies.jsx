...
const Competencies = () => {
  ...
  const competencies = [
    {
      ...
      image: '/assets/images/Medical-Equipment-Devices.jpg',
      link: '/medical-molding'
    },
    {
      id: 2,
    ...
    },
    {
      ...
      image: '/assets/images/Aerospace-Industry.jpg',
      link: '/aerospace-molding'
    },
    {
      id: 4,
    ...
    },
    {
      ...
      image: '/assets/images/assembly-services.jpg',
  ...
  return (
    <div className="w-full bg-gray-50">
      {/* Hero Section */}
      <section className="relative min-h-[calc(100vh-80px)] md:min-h-[400px] flex items-center overflow-hidden">
        {/* Background Image */}
        ...
        <div className="relative z-20 w-full pt-20 md:pt-20 lg:pt-20 xl-1300:pt-16 2xl:pt-24 pb-8 md:pb-12">
          <div className="mx-auto px-4 sm:px-6 md:px-8 lg:px-[48px] xl-1300:px-[40px] 2xl:px-[48px]">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-white text-3xl md:text-4xl lg:text-5xl xl-1300:text-4xl 2xl:text-6xl font-bold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {competencies.map((competency) => (
              <a
                ...
                className="group relative overflow-hidden rounded-lg bg-[#08222B] text-white transition-all duration-300 hover:shadow-2xl hover:scale-[1.02]"
                onMouseEnter={() => setHoveredCard(competency.id)}
                onMouseLeave={() => setHoveredCard(null)}
              >
                {/* Image Container - Shows on hover or stacked below */}
                <div className="relative h-40 md:h-48 lg:h-52 xl-1300:h-44 2xl:h-56 overflow-hidden">
                  <img
                    ...
                    className={`w-full h-full object-cover transition-all duration-500 ${
                      hoveredCard === competency.id ? 'scale-110 opacity-100' : 'opacity-0 scale-100'
                    }`}
                    onError={(e) => {
                      e.target.src = '/assets/images/about-us-banner.jpg';
                    }}
                  />
                  {/* Fallback gradient overlay when image is not visible */}
                  <div className={`absolute inset-0 bg-gradient-to-br from-[#08222B] to-[#0a2d38] transition-opacity duration-500 ${
                    hoveredCard === competency.id ? 'opacity-0' : 'opacity-100'
                  }`}></div>
                </div>

                {/* Content Container */}
                <div className="p-5 md:p-6 xl-1300:p-5 2xl:p-8">
                  <h3 className="text-lg md:text-xl lg:text-xl xl-1300:text-lg 2xl:text-2xl font-bold mb-2 xl-1300:mb-2 2xl:mb-3 group-hover:text-[#9CAEAF] transition-colors duration-300">
                    {competency.title}
                  </h3>
                  <p className="text-white/90 text-xs md:text-sm xl-1300:text-xs 2xl:text-base leading-relaxed">
