...
quick turnaround from concept to product.</p>
            ...
            <div className="md:col-span-2">
              <ul className="space-y-1 text-white/90">
                ...
                <li><a href="/thermoplastic-molding#injection-molding" className="hover:text-white text-sm">Injection Molding</a></li>
                <li><a href="/thermoplastic-molding#medical-molding" className="hover:text-white text-sm">Medical Molding</a></li>
                <li><a href="/thermoplastic-molding#aerospace-molding" className="hover:text-white text-sm">Aerospace Molding</a></li>
                <li><a href="/thermoplastic-molding#isbm" className="hover:text-white text-sm">Blow Molding</a></li>
                <li><a href="/silicone-molding#lsr-molding" className="hover:text-white text-sm">Silicone Molding - LSR</a></li>
                <li><a href="/silicone-molding#hcr-molding" className="hover:text-white text-sm">Silicone Molding - HCR</a></li>
                <li><a href="/silicone-molding#2k-molding" className="hover:text-white text-sm">2K Molding</a></li>
                <li><a href="/assembly-services" className="hover:text-white text-sm">Assembly</a></li>
              </ul>
            </div>
